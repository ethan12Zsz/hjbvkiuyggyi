...
module.exports = {
    ...
    async execute(client, message, args) {
        ...
        if (!command) message.lineReply(message.translate.owner.reload.cantFind(args[0]))
        try {
            ...
            message.lineReply(message.translate.owner.reload.success(args[0])).then(async (msg) => {
                msg.delete({
                    timeout: 5000
                })
            })
